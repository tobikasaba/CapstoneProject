...
class Photo(models.Model):
    ...
    class Meta:
        # This table is owned by the Pictures microservice, so Django should not manage it.
        managed = False
...
class Song(models.Model):
    ...
    class Meta:
        # This table is owned by the Songs microservice, so Django should not manage it.
        managed = False
